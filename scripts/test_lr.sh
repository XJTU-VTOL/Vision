...
# nohup python -u lightning_train.py --auto_lr_find True --batch-size 32 --accumulate_grad_batches 4 --cfg cfg/yolov3.cfg --data VisDrone --weights weights/yolov3.pt --max_epochs 300 --freeze --save_path ../lr_find_freeze --distributed_backend ddp --gpus 0,1 --num_workers 16 2>&1 >lightn.log &

# train without lr-find and freeze layers
mkdir -p ../no_lr_find_freeze
nohup python -u lightning_train.py --distributed_backend ddp --auto_lr_find False --batch-size 32 --accumulate_grad_batches 4 --cfg cfg/yolov3.cfg --data VisDrone --weights weights/yolov3.pt --max_epochs 300 --freeze --save_path ../yolov3_coco --gpus 0,1 --num_workers 16 2>&1 >lightn.log &
